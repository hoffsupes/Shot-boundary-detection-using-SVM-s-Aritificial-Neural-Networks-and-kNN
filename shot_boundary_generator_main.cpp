...
//         svm2->train(TrainData::create( tt_dat, cv::ml::ROW_SAMPLE, t_lab ));
        ...
        {
            float yy = svm->predict(tt_dat.row(i));
...
// generate_data(string("/home/user/RPI/PATTERN RECOGNITION/Project 1/Training Data"),string("/home/user/RPI/PATTERN RECOGNITION/Project 1/Training Labels"),string("tdatsmall_windo.xml"),string("tlabsmall_windo.xml"),dlimiter_on,nframesize);         
...
// generate_data(string("/home/user/RPI/PATTERN RECOGNITION/Project 1/Test Data"),string("/home/user/RPI/PATTERN RECOGNITION/Project 1/Test Labels"),string("test_data_small_windo.xml"),string("test_lab_small_windo.xml"),dlimiter_on,nframesize);         
